...
(function ($) {
    $.fn.showTopbarMessage = function (options) {
        ...
        var barStyle = " height: auto; width: 600px; position: fixed; min-height: " + options.height + ";margin-top:50%; top:-430px; margin-left:50%;left:-300px; display: none; z-index:30;";
        ...
        var overlayStyle = "height: " + options.height + ";filter: alpha(opacity=60);-moz-opacity: 0.6;-khtml-opacity: 0.6;opacity: 0.6;background-color: " + options.background + ";border: solid 2px " + options.borderColor + ";";
        var messageStyle = "font-family: Verdana; width: 100%;position: absolute;height: " + options.height + ";top: 40%;left: 0px;right: 0px;margin: 0px;color: " + options.foreColor + ";font-weight: bold;font-size: " + options.fontSize + ";text-align: center;padding: 10px 0px";
